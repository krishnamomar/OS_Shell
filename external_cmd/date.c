...
int main(int argc, char *argv[])
{
  ...
  for (int i = 1; i < argc; i++)
  {
    ...
    {
      if (strcmp(arg, "--universal") == 0) flag[1] = 1;
      else if (strcmp(arg, "--utc") == 0) flag[1] = 1;
      else if (strcmp(arg, "--rfc-email") == 0) flag[0] = 1;
      else
      {
    ...
    if (strlen(arg) > 1 && arg[0] == '-')
    {
      ...
      {
        char letter = arg[j];
        if (letter == 'u') flag[1] = 1;
        else if (letter == 'R') flag[0] = 1;
        else
        {
